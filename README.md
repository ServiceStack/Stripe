...
Like [ServiceStack.Text](https://github.com/ServiceStack/ServiceStack.Text), official releases of [ServiceStack.Stripe](https://www.nuget.org/packages/ServiceStack.Stripe) is a [free library for commercial or non-commercial use](https://docs.servicestack.net/releases/v4.0.62#servicestacktext-is-now-free).
